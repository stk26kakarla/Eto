...
namespace EtoWeb
{
    public class AuthRepository : IDisposable
    {
        ...
        public AuthRepository()
        {
            ...
            _userManager = new UserManager<ApplicationUser, int>(new UserStore<ApplicationUser, Role, int, UserLogin, UserRole, UserClaim>(_ctx));
        }

        public async Task<IdentityResult> RegisterUser(ApiApplicationUser userModel)
        {
